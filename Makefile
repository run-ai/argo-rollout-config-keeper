...
# run.ai/argo-rollout-config-keeper-bundle:$VERSION and run.ai/argo-rollout-config-keeper-catalog:$VERSION.
IMAGE_TAG_BASE ?= runaidevops/argo-rollout-config-keeper-operator
...
lint-fix: golangci-lint ## Run golangci-lint linter and perform fixes
	$(GOLANGCI_LINT) run --fix -v -c .golangci.yml
...
run: manifests generate fmt vet ## Run a controller from your host.
	go run ./cmd/main.go --zap-log-level=$(LOGLEVEL)
